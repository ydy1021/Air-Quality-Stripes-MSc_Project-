...
class NetCDFReader {
    constructor(data) {
        this.toString = toString_1.toString;
        const buffer = new iobuffer_1.IOBuffer(data);
        buffer.setBigEndian();
        // Validate that it's a NetCDF file
        (0, utils_1.notNetcdf)(buffer.readChars(3) !== 'CDF', 'should start with CDF');
        // Check the NetCDF format
        const version = buffer.readByte();
        (0, utils_1.notNetcdf)(version > 2, 'unknown version');
        // Read the header
        this.header = (0, header_1.header)(buffer, version);
        this.buffer = buffer;
    }
    /**
    ...
    getDataVariable(variableName) {
        ...
        if (variable.record) {
            ...
            return (0, data_1.record)(this.buffer, variable, this.header.recordDimension);
        }
        else {
            // non-record variable case
            return (0, data_1.nonRecord)(this.buffer, variable);
        }
    }
    /**
